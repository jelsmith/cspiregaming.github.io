...
angular.module('cSpireGamingWebApp').controller('MainCtrl', function ($scope, $filter) {
    ...
    $scope.events = [{
        title: 'December Meetup - Birthday Edition',
        subtitle: 'December 15, 2018 | 12 - 6 pm | C Spire HQ, 6th Floor',
        description: `<b>Happy First Birthday, C Spire Gaming!</b><br/>We're hoping this will be our biggest event yet! Bring your favorite video/table top games along with your consoles/PCs and hang out with some great people! (Please bring your own monitors too.) We'll provide pizza, drinks, and birthday cake. <br><br><b>SEE FULL DETAILS IN THE TICKET LINK BELOW</b>`,
